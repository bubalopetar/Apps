...
<div class="col-lg-10 col-lg-offset-1">
    ...
    {!! Form::open(['route' => 'addWard']) !!}
        ...
        <div class="col-lg-6">
                ...
                {{Form::text('prezime',null,array('class'=>'form-control','id'=>"forma"))}}

                {{ Form::label('dat_rođenja','Datum rođenja:') }}
                {{Form::date('dat_rođenja',null,array('class'=>'form-control','id'=>"forma"))}}

                {{ Form::label('adresa','Adresa:') }}
                {{Form::text('adresa',null,array('class'=>'form-control','id'=>"forma"))}}
